-- SystemUI embedded (external loadstring removed)
...
local Window = Library:CreateWindow('Blox Fruits Hub') -- CREATE WINDOW
...
-- discord changelog entry removed
...
task.spawn(function()
    while wait() do
        if getgenv().AntiKickClient then
            -- anti-kick external script removed
        end
    end
end)
